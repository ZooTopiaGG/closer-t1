...
export default {
    ...
    actions: {
        async getSubject({ commit }, payload) {
            // let { data } = await getSubject(payload).catch(function() {
            //     Toast("网络开小差啦~")
            // })
            ...
            let data = {
                "result": {
                    ...
                    "long_update_time": 1533525923948,
                    "tags": "0",
                    "long_share": 4,
                    "int_cover_mode": 0,
                    "verify_user": "wi4ThMgunRmN",
                    "classid": "9f32omiOVs",
