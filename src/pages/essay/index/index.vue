  ...
  <section class="essay">
    ...
    <section class="essay-wrap">
      <section class="essay-container">
        <!-- 标题 -->
        <h1>test</h1>
        <section class="essay-title"> {{ $store.state.essay.res.title }} </section>
        <!-- 暂时隐藏 -->
        ...
        <section class="content essay-content" v-html="$store.state.essay.content.html" v-lazy-container="{ selector: 'img' }" @click="openClick($event)">
        </section>
      </section>
    </section>
  </section>
