module.exports = {
  ...
  wxAuthorization: {
    build: 'https://h5.tiejin.cn/redirect?redirectUrl=https://a.tiejin.cn',
    sandbox: 'https://h5-sandbox.tiejin.cn/redirect?redirectUrl=https://a-sandbox.tiejin.cn',
    dev: 'https://h5-sandbox.tiejin.cn/redirect?redirectUrl=http://local.tiejin.cn:8889'
  }
}